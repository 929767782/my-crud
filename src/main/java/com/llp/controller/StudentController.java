...
import com.llp.bean.Msg;
import com.llp.bean.Student;
import com.llp.service.StudentService;
...
public class StudentController {
	...
	@RequestMapping("/getstus2")
	@ResponseBody
	public PageInfo getStus2(@RequestParam(value = "pn", defaultValue = "1") Integer pn, Model model){
		PageHelper.startPage(pn,5);
		List<Student> stus = studentService.getAll();
		PageInfo page = new PageInfo(stus,5);
		return page;
